...
export default function Hamburguer({ isOpen = false, ...props }) {
  ...
  function endPosition() {
    ...
    topPath.style.strokeDasharray = bottomPath.style.strokeDasharray =
      '0.8602325267 100'
    topPath.style.strokeDashoffset = bottomPath.style.strokeDashoffset =
      '-1.42540928658'
  }
  ...
  return (
    ...
    >
      ...
      `}</style>
      <path
        ref={elem => (topPath = elem)}
        id='top-path'
        d='M 0 0.25 L 0.15 0.25 h 0.7 a 0.25 0.1 90 1 1 0 0.5 L 0 0.14285714285'
      />
      <path
        ref={elem => (middlePath = elem)}
        id='middle-path'
        d='M 0.15 0.5 h 0.7'
      />
      <path
        ref={elem => (bottomPath = elem)}
        id='bottom-path'
        d='M 0 0.75 L 0.15 0.75 h 0.7 a 0.25 0.1 90 1 0 0 -0.5 L 0 0.85714285714'
      />
    </svg>
  )
}
